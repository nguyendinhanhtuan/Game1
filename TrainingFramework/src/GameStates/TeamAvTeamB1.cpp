...
TeamAvTeamB1::TeamAvTeamB1() : GameStateBase(StateType::STATE_TEAMAVTEAMB1), m_time(0.0f)
{
}


TeamAvTeamB1::~TeamAvTeamB1()
{
}


void TeamAvTeamB1::Init()
{
	...
	// background
	texture = ResourceManagers::GetInstance()->GetTexture("TeamAHoaTeamB1.tga");
...
void TeamAvTeamB1::Exit()
{
	ResourceManagers::FreeInstance();
}


void TeamAvTeamB1::Pause()
{
}

void TeamAvTeamB1::Resume()
{
}


void TeamAvTeamB1::HandleEvents()
{
}

void TeamAvTeamB1::HandleKeyEvents(int key, bool bIsPressed)
{
}

void TeamAvTeamB1::HandleTouchEvents(int x, int y, bool bIsPressed)
{
...
void TeamAvTeamB1::HandleMouseMoveEvents(int x, int y)
{
}

void TeamAvTeamB1::Update(float deltaTime)
{
