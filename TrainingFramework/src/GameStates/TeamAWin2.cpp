...
TeamAWin2::TeamAWin2() : GameStateBase(StateType::STATE_TEAMAWIN2), m_time(0.0f)
{
}
...
void TeamAWin2::Init()
{
	...
	// background
	texture = ResourceManagers::GetInstance()->GetTexture("TeamAWin2.tga");
...
void TeamAWin2::Pause()
{
}

void TeamAWin2::Resume()
{
}


void TeamAWin2::HandleEvents()
{
}

void TeamAWin2::HandleKeyEvents(int key, bool bIsPressed)
{
}

void TeamAWin2::HandleTouchEvents(int x, int y, bool bIsPressed)
{
...
void TeamAWin2::HandleMouseMoveEvents(int x, int y)
{
}

void TeamAWin2::Update(float deltaTime)
{
